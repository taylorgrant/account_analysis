...
user %>% 
  ...
  # DT::datatable(fillContainer = FALSE, rownames = FALSE,
  #               options = list(list(dom = 't'),
  #                              # autoWidth = TRUE,
  ...
  #             "}")
  #   )) %>% 
  # formatStyle(columns = c(1,2,3), fontSize = '13px')
```
...
tl %>% 
  ...
  knitr::kable(align = "lccccccccc", 
               col.names = c("Type", rep(c(handle, handle2, handle3), length(years)))) %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  kableExtra::add_header_above(c(" ", "2019" = 3, "2020" = 3, "2021" = 3), color = pal[4])
```
...
```{r, error = TRUE, fig.retina = 1}
knitr::include_graphics(collage3[3])
```
...
```{r, error = TRUE, fig.retina = 1}
knitr::include_graphics(collage3[2])
```
...
```{r, error = TRUE, fig.retina = 1}
knitr::include_graphics(collage3[1])
```
